...
static const int64_t MIN_TX_FEE = 500000;
...
static const int64_t COIN_YEAR_REWARD = 1 * CENT; // 1% per year - does this need to change?
...
inline bool IsProtocolV3(int64_t nTime) { return TestNet() || nTime > 0; }
