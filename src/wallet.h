...
public:
    ...
    bool CreateTransaction(const std::vector<tuple<CScript, int64_t, std::string> >& vecSend, CWalletTx& wtxNew, CReserveKey& reservekey, int64_t& nFeeRet, const CCoinControl *coinControl=NULL);
